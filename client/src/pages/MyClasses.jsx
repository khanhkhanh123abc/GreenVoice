        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Danh sách lớp học của bạn</p>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-slate-500 font-medium">
              {search ? "Không tìm thấy lớp học phù hợp" : "Bạn chưa được đăng ký vào lớp nào"}
            </p>
          </div>
        ) : (
            ...
            {filtered.map((cls) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-3 p-3 bg-slate-50 rounded-xl">
                  ...
                  <div>
                    <p className="text-xs text-slate-400 font-medium">Giáo viên</p>
                ...
                <div className="flex gap-2 mt-4 pt-4 border-t border-slate-100">
                  <span className="text-xs text-slate-400 flex items-center gap-1">
                    <Users size={11} /> Xem thành viên
                  </span>
                  <span className="text-slate-300">·</span>
                  <span className="text-xs text-slate-400 flex items-center gap-1">
                    <Star size={11} /> Đánh giá giáo viên
                  </span>
                  <span className="text-slate-300">·</span>
                  <span className="text-xs text-slate-400 flex items-center gap-1">
                    <BookOpen size={11} /> Tài liệu
                  </span>
                </div>
              </div>
            ))}
